...
public enum ServiceCode {
    ...
    SAVE_QRCODE_ERROR(30020, "生成二维码失败"),
    ...
    ENTERPRISE_TO_CHANNEL(40006, "企业生成渠道失败"),
    CHANNEL_INFORMATION_GET_FAILED(40007, "渠道信息获取失败"),
    CHANNEL_INFORMATION_SAVE_FAILED(40008, "渠道信息生成失败"),
    CHANNEL_INFORMATION_EXIST_FAILED(40009, "渠道信息已存在");
